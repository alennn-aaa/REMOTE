...
test1 и test2 были удалены, в test1 было слияние с конфликтом. в test2 была добавлена информация, после чего test2 был удален принудительно. теперь попробую просто слить test3 и test4.

получилось, далее:

test5 попробую слить. с конфликтом, с веткой test6
слияние произошло, но конфликта не получилось..
попробую теперь еще раз, на этот раз попробую добиться конфликта.
не получилось, он сливает без конфликта, видимо мало изменений вношу в прошлый текст.